...
<section class="casein">
    <div class="container">
        ...
        <?php if (!empty($fields_desc)) { ?>
            <div class="casein__description"><?php echo wp_kses_post($fields_desc); ?></div>
        <?php }
        ?>
        <div class="casein__three">
            <div class="casein__three-item">
                <?php
                if (!empty($fields_photo1)) { ?>
                    <div class="casein__three-item-image">
                ...
                if (!empty($fields_desc1)) { ?>
                    <a href="<?php echo $fields_link1; ?>">
                        <div class="casein__three-item-description">
